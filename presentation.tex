...
\begin{itemize}
    \item \textbf{The Sun} --- where is it right now?
    \item \textbf{The centre of our Galaxy}
    \item \textbf{The Andromeda Galaxy}
\end{itemize}
\end{column}
...
Pluto        & Grain of sand (0.4\,mm) & 1\,km \\
Voyager~1    & ---                  & 4.2\,km \\
\midrule
...
\begin{itemize}
    ...
    \item That tiny coin is our \textbf{entire Solar System}
...
\begin{tabular}{llrc}
\toprule
\textbf{Era} & \textbf{Catalogue} & \textbf{Stars} & \textbf{Year} \\
\midrule
Naked eye    & Hipparchus          & $\sim$850        & 129\,BC \\
             & Tycho Brahe         & $\sim$1{,}000    & $\sim$1600 \\
Telescopes   & John Flamsteed      & $\sim$3{,}000    & 1725 \\
Photography  & Bonner Durchmusterung & $\sim$324{,}000  & 1859 \\
             & Henry Draper        & $\sim$225{,}000  & 1924 \\
\midrule
From space   & Hipparcos           & 118{,}218       & 1997 \\
             & Tycho-2             & $\sim$2.5 million & 2000 \\
             & \textbf{Gaia}       & \textbf{$\sim$2 billion} & \textbf{2022+} \\
\bottomrule
\end{tabular}
...
\begin{center}
\small $\sim$1{,}000 $\rightarrow$ $\sim$3{,}000 $\rightarrow$ $\sim$300{,}000 $\rightarrow$ millions $\rightarrow$ \textbf{2 billion}
\end{center}

\end{frame}

% ============================================================
\begin{frame}{The Gaia Mission}

\begin{itemize}\setlength{\itemsep}{4pt}
    \item A European Space Agency (\textbf{ESA}) mission
    \item Goal: create the most detailed \textbf{3D map} of the Milky Way
    \item Cost: $\sim$\textbf{740 million euros}
    \item Built by $\sim$50 companies from \textbf{15 European countries}
    \item Team effort: $\sim$450 scientists and engineers from \textbf{20+ countries}
    \item \textbf{6 data processing centres} across Europe, including Cambridge
\end{itemize}
...
\begin{itemize}
    ...
    \item Camera: \textbf{1 billion pixels} (106 CCDs)
\end{itemize}
\end{column}
\begin{column}{0.43\textwidth}
\begin{center}
...
\begin{center}
\small
Hipparchus made one of the first star catalogues.\\
Ptolemy used and preserved this work.\\
It influenced astronomy for $\sim$\textbf{1{,}500 years}.
\end{center}

\smallskip

\begin{itemize}\setlength{\itemsep}{2pt}
    \item Tycho Brahe's data enabled Kepler to discover the \textbf{laws of planetary motion}
    \item Hipparcos is still used today, alongside Gaia, $\sim$\textbf{30 years} after publication
    \item The Gaia catalogue will serve astronomy for \textbf{decades to come}
\end{itemize}
