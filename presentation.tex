...
Later, Ptolemy used and preserved this work.\\
And it influenced astronomy for $\sim$\textbf{1{,}500 years}.
\end{center}

\bigskip

\begin{itemize}
    \item Tycho Brahe's data enabled Johannes Kepler to discover the \textbf{laws of planetary motion}
    \item The Hipparcos catalogue is still used today, alongside newer Gaia data, $\sim$\textbf{30 years} after publication
