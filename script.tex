...
Hello everyone. My name is Michael, and I work at the Institute of Astronomy here in Cambridge. Today I'd like to tell you about my project --- a space mission called Gaia. But first, let's think about how big the universe really is.
...
First --- the Sun. Right now, the Sun is in \emph{that} direction, roughly south. It's about 150 million kilometres away. Light from the Sun takes about 8 minutes to reach us. So the sunlight you see right now left the Sun 8 minutes ago.
...
These numbers --- millions, billions, trillions of kilometres --- are very hard to imagine. So let me use a comparison.
...
And the nearest star? The nearest star would be \emph{another basketball}\ldots{} about 6,900 kilometres from here. Roughly the distance from Cambridge to Mumbai. That's how empty space is. That's the main idea --- space is mostly empty.
...
People have been making catalogues of stars for thousands of years. A star catalogue is basically a list --- where each star is on the sky, and how bright it is. Simple idea, but extremely important for astronomy and navigation.

The first serious catalogue was made by Hipparchus, a Greek astronomer, around 129~BC. He recorded about 850 stars. For about 1,500 years, that was the best we had.
...
The real leap came in the 19th century, with photography. Suddenly, hundreds of thousands of stars could be catalogued. Then in 1989, the European Space Agency launched a satellite called Hipparcos --- named after Hipparchus. From space, Hipparcos measured 118,000 stars with very high precision. A related catalogue, Tycho-2, reached 2.5 million stars.
...
\begin{slidenote}
``The Gaia Mission'' slide.
\end{slidenote}

Gaia is a big European project --- about 450 scientists and engineers from more than 20 countries, working together. The data is processed in six centres across Europe. One of those centres is here in Cambridge, at the Institute of Astronomy, where I work.

\begin{slidenote}
``What Is Gaia?'' slide.
\end{slidenote}

So what is Gaia exactly? It is a space telescope that was launched in December 2013. Its goal was to create the most detailed three-dimensional map of our galaxy. The satellite operated for 11 years --- more than double the planned five years, and took its last observation in January 2025.
...
L2 is a point about 1.5 million kilometres from Earth, on the opposite side from the Sun. At this point, the gravity of the Sun and Earth balance in a useful way, keeping a satellite in a stable position. Gaia stayed behind the Earth, so the Sun, Earth, and Moon were all on one side --- behind a sunshield. This means Gaia had a clear, dark, stable view of the sky.
...
So what has Gaia found? The latest big data release, called Data Release 3, was published in June 2022. It contains positions of about 1.8 billion stars.

\begin{stagenote}
Pause. Let that number sink in.
\end{stagenote}

That's a huge number. For about 1.5 billion of them, we also have distances and motions.
...
Gaia's catalogue of 2 billion stars\ldots{} will be used by astronomers\ldots{} long after all of us in this room are gone.

\begin{stagenote}
Pause between phrases for effect.
\end{stagenote}

There is something very satisfying about working on something that will last.
