...
It is almost directly above us! About 2.5 million light-years away.

So right now, while we sit here, we are surrounded by the universe in every direction --- planets below us, galaxies above us.
...
Jupiter, the biggest planet, would be the size of a walnut --- 134 metres from the basketball. Neptune would be a peanut, 774 metres away.
...
And inside our Cambridge-sized galaxy, there are 200 to 400 billion of these little coins. Each one is a star with its own planets. Most of the space between them is empty.
...
Our galaxy is a spiral galaxy. If you could see it from above, it would look like a beautiful spiral with long arms. Our Sun is in one of these arms, about two thirds of the way out from the centre.
...
The first serious catalogue was made by Hipparchus, a Greek astronomer, around 129 BC. He recorded about 850 stars. Three hundred years later, Ptolemy extended this to about 1,000 stars in his famous book, the Almagest.

For the next 1,500 years, these catalogues were the best we had. Astronomers and sailors used them for centuries.

Then came telescopes. Tycho Brahe measured about 1,000 stars with incredible accuracy for his time. Flamsteed at Greenwich recorded about 3,000. But still --- just a few thousand stars. Then in 1989, the European Space Agency launched a satellite called Hipparcos --- named after Hipparchus. From space, away from the atmosphere, Hipparcos measured 118,000 stars with very high precision.
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Images to add to slides:}
    \begin{itemize}
        \item Milky Way artist's impression (ESA/Gaia)
        \item Gaia satellite (ESA image)
        \item Gaia scanning law diagram (ESA)
        \item Gaia sky map (ESA/Gaia/DPAC)
    \end{itemize}
    \item All ESA/Gaia images are freely available at \texttt{sci.esa.int/gaia}
\end{itemize}
